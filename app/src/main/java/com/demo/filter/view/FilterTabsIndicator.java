...
public class FilterTabsIndicator extends LinearLayout {
    ...
    private int mDividerColor = 0xFFcccccc;// 分割线颜色
    ...
    private int mLineColor = 0xFFcccccc;// 分割线颜色
    ...
    public FilterTabsIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public FilterTabsIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    private View generateTextView(String title, int pos) {
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.level_filter);//设置箭头方向
